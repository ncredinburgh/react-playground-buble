...
class ModalProvider extends React.Component {
  ...
  portalRender = props => {
    const { themeChooser, children, onCancel } = props
    ...
    ReactDOM.render(
      <ThemeProvider theme={theme}>
        <Modal show={show} portal={false} zIndex={1000} onCancel={onCancel}>
          {content}
        </Modal>
      </ThemeProvider>
    , this.el)
...
export default enhance(ModalProvider)
